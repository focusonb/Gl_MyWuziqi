...
static float squareVertices3[] = {
	1.0f, -0.1f, 0.0f,  1.0f, 0.0f,	//right down
	-0.1f, -0.1f, 0.0f,  0.0f, 0.0f,	//left down
	-0.1f,  1.0f, 0.0f,  0.0f, 1.0f,	//left up
	1.0f,  1.0f, 0.0f,  1.0f, 1.0f,	//right up
	1.0f, -0.1f, 0.0f,  1.0f, 0.0f,	//right down
	-0.1f,  1.0f, 0.0f,  0.0f, 1.0f,	//left up
};
static float outSquareVertices3[] = {
		0.95f, -0.05f, -0.1f,  0.0f, 255.0f,0.0f,	//right down
	-0.05f, -0.05f, -0.1f,  0.0f, 255.0f,0.0f,	//left down
	-0.05f,  0.95f, -0.1f,  0.0f, 255.0f,0.0f,	//left up
	0.95f,  0.95f, -0.1f,  0.0f, 255.0f,0.0f,	//right up
	0.95f, -0.05f, -0.1f,  0.0f, 255.0f,0.0f,	//right down
	-0.05f,  0.95f, -0.1f,  0.0f, 255.0f,0.0f,	//left up
};
